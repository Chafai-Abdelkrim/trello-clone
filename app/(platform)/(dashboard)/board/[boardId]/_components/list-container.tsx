...
export const ListContainer = ({ data, boardId }: ListConatinerProps) => {
  ...
  const onDragEnd = (result: any) => {
    ...
    if (type === "card") {
      ...
      //check if cards cards exist on the source list
      if (!sourceList.cards) sourceList.cards = [];

      //check if cards cards exist on the destination list
      ...
      if (source.droppableId === destination.droppableId) {
        ...
        //TODO: Trigger serve action

        //User moves the card to another list
      } else {
        //removing the moved card from the source list
